...
class Trainer:
    def __init__(self, options):
        ...
        if self.opt.encoder_type == "hyenapixel":
            self.models["encoder"] = networks.HyenaPixelEncoder(
        ...
        if self.opt.use_guided_upsample:
            self.models["depth"] = networks.DepthDecoderGuided(
    ...
    def process_batch(self, inputs):
        ...
        if self.opt.pose_model_type == "shared":
            ...
            if self.opt.use_guided_upsample:
                outputs = self.models["depth"](features[0], inputs[("color_aug", 0, 0)])
            else:
            ...
            if self.opt.use_guided_upsample:
                outputs = self.models["depth"](features, inputs[("color_aug", 0, 0)])
            else:

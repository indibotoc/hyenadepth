...
class MonodepthOptions:
    def __init__(self):
        ...
        self.parser.add_argument("--encoder_type",
                                 ...
                                 default="resnet",
                                 choices=["resnet", "hyenapixel"])
        self.parser.add_argument("--use_guided_upsample",
                                 help="use image-guided learned upsampling in depth decoder "
                                      "(FeatUp-inspired; requires --encoder_type hyenapixel)",
                                 action="store_true")
        self.parser.add_argument("--num_layers",
                                 type=int,
                                 help="number of resnet layers (ignored when --encoder_type hyenapixel)",
                                 default=18,
